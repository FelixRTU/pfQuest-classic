...
pfQuestConfig:SetScript("OnEvent", function(this, event, arg1)
...
pfQuestConfig:SetScript("OnMouseDown", function(this)
  this:StartMoving()
end)

pfQuestConfig:SetScript("OnMouseUp", function(this)
  this:StopMovingOrSizing()
end)

pfQuestConfig:SetScript("OnShow", function(this)
...
pfQuestConfig.close:SetScript("OnClick", function(this)
 this:GetParent():Hide()
end)
  ...
  for entry, data in pairs(config) do
    if data.pos and data.type then
      ...
      elseif data.type == "checkbox" then
        ...
        frame.input:SetScript("OnClick", function(this)
      ...
      elseif data.type == "text" then
        ...
        frame.input:SetScript("OnEscapePressed", function(this)
          this:ClearFocus()
        end)
        ...
        frame.input:SetScript("OnTextChanged", function(this)
  ...
  for entry, data in pairs(pfQuest_defconfig) do
    if data.pos and data.type and configframes[entry] then
      if data.type == "checkbox" then
        configframes[entry].input:SetChecked(pfQuest_config[entry] == "1")
      elseif data.type == "text" then
