...
local function OnEnter(this)
  if this.id then
    ...
    pfDatabase:ShowExtendedTooltip(this, this.id, tooltip, parent, anchor, offx, offy)
...
local function RemoveOnClick(this)
...
pfJournal:SetScript("OnMouseDown",function(this)
  this:StartMoving()
end)

pfJournal:SetScript("OnMouseUp",function(this)
...
pfJournal.close:SetScript("OnClick", function(this) this:GetParent():Hide() end)
...
pfJournal.entries:SetScript("OnMouseWheel", function(this, arg1)
  this.offset = this.offset and this.offset - arg1 or 0
  this:ReloadJournal()
end)

pfJournal.entries:SetScript("OnClick", ReloadJournal)
pfJournal.entries:SetScript("OnUpdate", function(this)
