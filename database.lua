...
pfDatabase.itemlist:SetScript("OnEvent", function(this)
  this.update = GetTime() + .5
  this:Show()
end)

pfDatabase.itemlist:SetScript("OnUpdate", function(this)
...
if pfQuestCompat.client > 11306 then
...
function pfDatabase:ShowExtendedTooltip(this, id, tooltip, parent, anchor, offx, offy)
  local tooltip = GameTooltip--tooltip or GameTooltip
  ...
  -- fix for quest journal tooltips -> has no questid
...
pfServerScan:SetScript("OnShow", function(this)
  this.scanID = 1
